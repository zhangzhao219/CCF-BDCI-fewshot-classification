...
parser.add_argument('--modify', type=int, default=0, help='Small change num')
...
if __name__ == '__main__':
    ...
    if args.modify != 0:
        row = np.random.randint(len(output_data), size=(1, args.modify))
        for num in row:
            output_data.loc[num,'label'] = 35 - output_data.loc[num,'label']
