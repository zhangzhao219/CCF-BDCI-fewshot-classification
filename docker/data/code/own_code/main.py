...
# log
config_logging("../../user_data/log/log_" + TIMESTAMP)
...
def train(args,data):
    ...
    for n_fold in range(args.K_stop):
        # build model
...
if __name__ == '__main__':
    ...
    MODEL_PATH = '../../user_data/models_after_train/' + TIMESTAMP + '/'

    DATA_PATH = os.path.join(args.data_folder_dir,args.data_file)
