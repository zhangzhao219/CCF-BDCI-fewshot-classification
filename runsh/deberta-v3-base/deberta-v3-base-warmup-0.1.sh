...
BERT='pretrained/microsoft/deberta-v3-base'
...
python main.py \
--train \
--batch 64 --board --datetime ${TIMESTAMP} --epoch 40 --gpu 12 13 14 15 --lr 2e-5 --seed ${SEED} \
...
python main.py \
--test \
--batch 128 --datetime ${TIMESTAMP} --gpu 12 13 14 15 --seed ${SEED} \
--data_folder_dir fewshot --data_file expand_train_cur_best_en.json --label 36 \
--bert ${BERT} --dropout 0.3 \
--K ${K}
