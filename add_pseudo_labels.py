...
parser.add_argument('--percent', type=float, default=10, help='top percent confidence score will be regarded as reliable pseudo labels for a given class')
...
for l in range(num_labels):
    ...
    thresh = np.percentile(sub_score, 30)
    if thresh < 0.7:
        thresh = 0.7
