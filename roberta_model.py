...
def getBert(bert_name):
    ...
    model_config = RobertaConfig.from_pretrained(bert_name)
    model_config.output_hidden_states = True
    roberta = RobertaModel.from_pretrained(bert_name,config=model_config)
    return roberta
...
class PretrainedModel(nn.Module):
    def __init__(self, roberta, n_labels, feature_layers, dropout):
        super(PretrainedModel, self).__init__()
        self.roberta = getBert(roberta)
